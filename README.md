...
A very popular option is [**gdb**](https://www.gnu.org/software/gdb/). This debugger comes along with most compilers available on each platform. So, if you already have installed a C compiler, most likely you also have access to the gdb debugger.
